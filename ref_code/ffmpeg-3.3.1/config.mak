...
CC_IDENT=Apple LLVM version 8.1.0 (clang-802.0.42)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -I/usr/local/opt/opencv3/include -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DPIC -DZLIB_CONST
CFLAGS=   -std=c11 -fomit-frame-pointer -fPIC -pthread -D_THREAD_SAFE -I/usr/local/include/SDL2 -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/usr/local/opt/opencv3/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
...
ASMSTRIPFLAGS= -x
YASMFLAGS=-f macho64 -m amd64 -DPIC -DPREFIX
BUILDSUF=
PROGSSUF=
...
CFLAGS-ffplay=-D_THREAD_SAFE -I/usr/local/include/SDL2
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-framework QuartzCore -framework QuartzCore -framework AppKit -framework OpenGL -framework QuartzCore -framework AppKit -framework OpenGL -framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework CoreVideo -framework CoreFoundation -framework AudioToolbox -framework CoreMedia -framework VideoDecodeAcceleration -framework CoreFoundation -framework QuartzCore -liconv -Wl,-framework,CoreFoundation -Wl,-framework,Security -L/usr/local/lib -lSDL2 -framework CoreGraphics -lm -llzma -lbz2 -lz -pthread -framework CoreServices 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavcodec_VERSION=57.89.100
libavcodec_VERSION_MAJOR=57
libavcodec_VERSION_MINOR=89
libavdevice_VERSION=57.6.100
libavdevice_VERSION_MAJOR=57
libavdevice_VERSION_MINOR=6
libavfilter_VERSION=6.82.100
libavfilter_VERSION_MAJOR=6
libavfilter_VERSION_MINOR=82
libavformat_VERSION=57.71.100
libavformat_VERSION_MAJOR=57
libavformat_VERSION_MINOR=71
libavresample_VERSION=3.5.0
libavresample_VERSION_MAJOR=3
libavresample_VERSION_MINOR=5
libavutil_VERSION=55.58.100
libavutil_VERSION_MAJOR=55
libavutil_VERSION_MINOR=58
libpostproc_VERSION=54.5.100
libpostproc_VERSION_MAJOR=54
libpostproc_VERSION_MINOR=5
libswresample_VERSION=2.7.100
libswresample_VERSION_MAJOR=2
libswresample_VERSION_MINOR=7
libswscale_VERSION=4.6.100
libswscale_VERSION_MAJOR=4
libswscale_VERSION_MINOR=6
...
LIBS-ffplay=-L/usr/local/lib -lSDL2
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
